...
namespace Data
{
    public static class Seed
    {
        ...
        public static readonly List<Component> Components = new()
        {
            ...
            new Processor { Name = "Super Mega Good", ProcessorType = Enums.ProcessorType.Deca, Price = 300, Weight = 0.1, Manufacturer = manufacturers[0] },
            new Processor { Name = "Very Very Good", ProcessorType = Enums.ProcessorType.Octa, Price = 100, Weight = 0.1, Manufacturer = manufacturers[0] },
            new Processor { Name = "DeGud CPU yess", ProcessorType = Enums.ProcessorType.Octa, Price = 500, Weight = 0.1, Manufacturer = manufacturers[1] },
